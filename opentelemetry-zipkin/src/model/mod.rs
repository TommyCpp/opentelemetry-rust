use opentelemetry::{exporter, trace, Key, KeyValue};
...
/// Converts `trace::Event` into an `annotation::Annotation`
impl Into<annotation::Annotation> for trace::Event {
...
fn from_statuscode_to_str(status_code: trace::StatusCode) -> &'static str {
    match status_code {
        trace::StatusCode::OK => "OK",
        trace::StatusCode::Canceled => "CANCELLED",
        trace::StatusCode::Unknown => "UNKNOWN",
        trace::StatusCode::InvalidArgument => "INVALID_ARGUMENT",
        trace::StatusCode::DeadlineExceeded => "DEADLINE_EXCEEDED",
        trace::StatusCode::NotFound => "NOT_FOUND",
        trace::StatusCode::AlreadyExists => "ALREADY_EXISTS",
        trace::StatusCode::PermissionDenied => "PERMISSION_DENIED",
        trace::StatusCode::ResourceExhausted => "RESOURSE_EXHAUSTED",
        trace::StatusCode::FailedPrecondition => "FAILED_PRECONDITION",
        trace::StatusCode::Aborted => "ABORTED",
        trace::StatusCode::OutOfRange => "OUT_OF_RANGE",
        trace::StatusCode::Unimplemented => "UNINPLEMENTED",
        trace::StatusCode::Internal => "INTERNAL",
        trace::StatusCode::Unavailable => "UNAVAILABLE",
        trace::StatusCode::DataLoss => "DATA_LOSS",
        trace::StatusCode::Unauthenticated => "UNAUTHENTICATED",
    }
}

/// Converts `trace::SpanKind` into an `Option<span::Kind>`
fn into_zipkin_span_kind(kind: trace::SpanKind) -> Option<span::Kind> {
    match kind {
        trace::SpanKind::Client => Some(span::Kind::Client),
        trace::SpanKind::Server => Some(span::Kind::Server),
        trace::SpanKind::Producer => Some(span::Kind::Producer),
        trace::SpanKind::Consumer => Some(span::Kind::Consumer),
        trace::SpanKind::Internal => None,
    }
}
...
pub(crate) fn into_zipkin_span(
    ...
    span_data: exporter::trace::SpanData,
) -> span::Span {
